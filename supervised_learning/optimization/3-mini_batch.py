...
def train_mini_batch(X_train, Y_train, X_valid, Y_valid, batch_size=32,
    ...
    Args:
        X_train (np.array): matrix of shape (m, 784) containing the training
            data
        Y_train (np.array): one-hot matrix of shape (m, 10) containing the
            training labels
        X_valid (np.array): matrix of shape (m, 784) containing the validation
            data
